...
public class ClipBroadcastIntents {
    ...
    public static final String ACTION_URI_SEND = "com.flicktekltd.clip.ACTION_URI_SEND";
    public static final String ACTION_URI_GESTURE = "com.flicktekltd.clip.ACTION_GESTURE";
    public static final String ACTION_URI_WAKEUP = "com.flicktekltd.clip.ACTION_WAKEUP";
    public static final String ACTION_URI_BACK = "com.flicktekltd.clip.ACTION_BACK";

    public static final String EXTRA_URI = "com.flicktekltd.clip.EXTRA_URI";
