...
import com.flicktekltd.clip.eventbus.BluetoothStateEvent;
import com.flicktekltd.clip.eventbus.ConnectedEvent;
import com.flicktekltd.clip.eventbus.ConnectingEvent;
import com.flicktekltd.clip.eventbus.DeviceToPhoneEvent;
import com.flicktekltd.clip.eventbus.DeviceToWearEvent;
import com.flicktekltd.clip.eventbus.DisconnectedEvent;
import com.flicktekltd.clip.eventbus.DisconnectingEvent;
import com.flicktekltd.clip.eventbus.LinkLossEvent;
...
public class FlicktekManager {
    ...
    public boolean isFirstReleaseVersion() {
        String firmware_version = getFirmwareVersion();
        if (firmware_version == null)
            return false;
    ...
    public boolean isBondingSupported() {
        // TODO Check version release
        return false;
    }
